...
这份手册面向 [nuomiiiii/komari](https://github.com/nuomiiiii/komari)，不是上游 `komari-monitor/komari` 的原样镜像。安装脚本、Docker 镜像、Agent、数据库迁移和后台功能均以本分支为准。
...
默认 Web 端口为 `25774`。首次打开 `http://服务器地址:25774` 后，按照初始化页面创建管理员账号。
